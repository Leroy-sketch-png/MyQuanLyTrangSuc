    ...
    public class ProfilePageLogic : INotifyPropertyChanged
    {
        ...
        public ProfilePageLogic(ProfilePage profilePageUI)
        {
            ...
            if (employee != null)
            {
                ...
                DateOfBirth = employee.DateOfBirth.HasValue ? (DateTime?)employee.DateOfBirth.Value.ToDateTime(TimeOnly.MinValue) : null;
            ...
            if (account != null)
            {
                ...
                if (employee != null)
                {
                    bool isUpdated = false;
                        ...
                        employee.DateOfBirth = DateOnly.FromDateTime(DateOfBirth.Value);
